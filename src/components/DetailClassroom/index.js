...
const DetailClassroom = () => {
  const router_tab = [
    { name_header: "Stream", link: "/detail-classroom/newfeed", value: 1 },
    {
      name_header: "Exercises",
      link: "/detail-classroom/exercises",
      value: 2,
    },
    { name_header: "People", link: "/detail-classroom/member", value: 3 },
    { name_header: "Grade", link: "/detail-classroom/grades", value: 4 },
  ];
